...
}, '1.7.0pr2' ,{requires:['datatable-base','calendar','aui-datatype','aui-toolbar','aui-form-validator','overlay','sortable'], skinnable:true});
...
}, '1.7.0pr2' ,{requires:['datatable-base'], skinnable:true});
...
}, '1.7.0pr2' ,{requires:['aui-datatable-selection'], skinnable:true});


AUI.add('aui-datatable', function(A){}, '1.7.0pr2' ,{skinnable:true, use:['aui-datatable-edit','aui-datatable-selection','aui-datatable-highlight']});
