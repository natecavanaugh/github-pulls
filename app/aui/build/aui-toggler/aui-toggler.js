...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-base','transition']});
...
}, '1.7.0pr2' ,{requires:['aui-toggler-base'], skinnable:false});


AUI.add('aui-toggler', function(A){}, '1.7.0pr2' ,{skinnable:true, use:['aui-toggler-base','aui-toggler-delegate']});
