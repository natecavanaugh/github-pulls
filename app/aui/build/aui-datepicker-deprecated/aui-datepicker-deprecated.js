...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-calendar','aui-overlay-context']});
...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-datepicker-base-deprecated','aui-button-item']});


AUI.add('aui-datepicker-deprecated', function(A){}, '1.7.0pr2' ,{skinnable:true, use:['aui-datepicker-base-deprecated','aui-datepicker-select-deprecated']});
