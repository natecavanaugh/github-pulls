...
}, '1.7.0pr2' ,{requires:['aui-base','datasource','dataschema']});
...
}, '1.7.0pr2' ,{requires:['aui-base','aui-datasource-control-base','aui-form-combobox']});


AUI.add('aui-datasource-control', function(A){}, '1.7.0pr2' ,{skinnable:true, use:['aui-datasource-control-base','aui-input-text-control']});
