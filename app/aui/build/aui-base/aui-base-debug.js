...
;(function() {
	/*
	 * Alloy JavaScript Library v1.7.0pr2
...
}, '1.7.0pr2' ,{requires:['aui-classnamemanager','aui-node','aui-component','aui-debounce','aui-delayed-task','aui-selector','aui-event-base','oop','yui-throttle'], skinnable:false});
...
}, '1.7.0pr2' ,{skinnable:false});


AUI.add('aui-base', function(A){}, '1.7.0pr2' ,{skinnable:false, use:['aui-base-core','aui-base-lang']});
