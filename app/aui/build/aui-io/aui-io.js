...
}, '1.7.0pr2' ,{requires:['aui-base','io-base','json','plugin','querystring-stringify']});
...
}, '1.7.0pr2' ,{requires:['aui-overlay-base','aui-parse-content','aui-io-request','aui-loading-mask']});


AUI.add('aui-io', function(A){}, '1.7.0pr2' ,{use:['aui-io-request','aui-io-plugin'], skinnable:false});
