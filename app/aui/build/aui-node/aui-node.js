...
}, '1.7.0pr2' ,{requires:['array-extras','aui-base-lang','aui-classnamemanager','node']});
...
}, '1.7.0pr2' ,{requires:['collection','aui-base']});
...
}, '1.7.0pr2' ,{requires:['aui-node-html5']});


AUI.add('aui-node', function(A){}, '1.7.0pr2' ,{skinnable:false, use:['aui-node-base','aui-node-html5','aui-node-html5-print']});
