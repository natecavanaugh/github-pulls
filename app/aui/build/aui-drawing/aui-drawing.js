...
}, '1.7.0pr2' ,{requires:['aui-base','aui-color-util','substitute']});
...
}, '1.7.0pr2' ,{requires:['aui-drawing-base']});
...
}, '1.7.0pr2' ,{requires:['aui-drawing-base','event-gestures']});
...
AUI.add('aui-drawing', function(A){}, '1.7.0pr2' ,{skinnable:false, use:['aui-drawing-base', 'aui-drawing-animate', 'aui-drawing-drag', 'aui-drawing-fonts']});
