...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-base','aui-color-util','aui-datatype','button-group','model','model-list','widget-stdmod']});
...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-scheduler-view-table','dd-drag','dd-delegate','dd-drop','dd-constrain']});
...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-scheduler-view-day']});
...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-scheduler-base','overlay']});
...
}, '1.7.0pr2' ,{skinnable:false, requires:['aui-scheduler-view-table','dd-drag','dd-delegate','dd-drop','dd-constrain']});
...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-scheduler-view-table']});
...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-scheduler-base','aui-template','aui-toolbar','io-form','querystring','overlay']});


AUI.add('aui-scheduler', function(A){}, '1.7.0pr2' ,{use:['aui-scheduler-base','aui-scheduler-view-day','aui-scheduler-view-week','aui-scheduler-view-table','aui-scheduler-view-table-dd','aui-scheduler-view-month','aui-scheduler-event-recorder'], skinnable:false});
