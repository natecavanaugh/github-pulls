...
}, '1.7.0pr2' ,{requires:['aui-base','aui-task-manager'], skinnable:false});
...
}, '1.7.0pr2' ,{requires:['aui-tree-data','aui-io','json','querystring-stringify'], skinnable:false});
...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-tree-node','dd-delegate','dd-proxy']});


AUI.add('aui-tree', function(A){}, '1.7.0pr2' ,{skinnable:true, use:['aui-tree-data', 'aui-tree-node', 'aui-tree-view']});
