...
}, '1.7.0pr2' ,{skinnable:true, requires:['aui-datatype','aui-panel','aui-tooltip']});


AUI.add('aui-form-builder', function(A){}, '1.7.0pr2' ,{use:['aui-form-builder-base','aui-form-builder-field'], skinnable:true});
